...
Features:
- Shortens record ID from xxxxx-xxxxx to xxxx-xxxx in DOI
...
class CustomDataCiteClient(DataCiteClient):
    """Custom DataCite Client with shortened DOI format (xxxx-xxxx)."""

    def _shorten_id(self, record_id):
        """Shorten record ID from xxxxx-xxxxx to xxxx-xxxx format."""
        if not record_id:
            return record_id
